...
public class TataDocomo implements MobileNetWork {
	...
	public String plan(String businessType, Integer amount, String rechargeType, String plans) {
		...
		System.out.println("Welcome to TataDocomo "+businessType+" subscriber");
		...
		return "Thanks for using TataDocomo network";
	}
